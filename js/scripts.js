(function($) {
    ...
    $(document).ready(function() {
        ...
        var win_h = $(window).height(), win_w = window.innerWidth, headerHeight = $('header').height(), footerHeight = $('footer').height(), resizeTimer, landing_slides_arr = [], is_desktop = true, is_tablet = false, is_mobile = false;
	...
	*/
        ...
        if ($(".portfolio .filters, .gallery .filters").length > 0) {
            ...
            $(".portfolio .filters span, .gallery .filters span").click(function(event) {
                ...
                var target = $(this).attr('data-filter'), type = $(this).parent().attr('data-type') || 'opacity', wrapper = $(this).parent().parent(), elements_wrapper, element;
                ...
                if (!$(this).hasClass('active')) {
                    ...
                    if (type == "isotope") {
                        wrapper.find(elements_wrapper).isotope({
                            filter: target
                        });
                    } else {
                        if (target == "*") {
        ...
        function draw(resize=false) {
            ...
            if ($(".horizontal-slider.centered > .swiper-container, .horizontal-slider.full > .swiper-container").length > 0) {
                ...
                if (!resize) {
                    ...
                    $(".horizontal-slider.centered > .swiper-container, .horizontal-slider.full > .swiper-container").each(function() {
                        ...
                        var slider = $(this), slider_id = '#' + slider.attr('id'), active_slide = 0, mousewheel_status = slider.parent().attr('data-mousewheel') || '', mousewheel_obj, space_between_slides = 0, slides_per_view;
            ...
            if ($(".grid.isotope, .masonry").length > 0) {
                ...
                $(".grid.isotope, .masonry").each(function() {
                    ...
                    var wrapper = $(this), instance, element;
            ...
            if ($(".landing-strips-slideshow").length > 0) {
                ...
                var strips_slides_interval, columns = $(".landing-strips-slideshow .strips .flexslider").length;
